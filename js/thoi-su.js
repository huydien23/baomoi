// thoi-su.js
// Xử lý hiển thị dữ liệu cho trang Thời sự
...
async function loadCategoryNews() {
  try {
    console.log("Đang tải tin tức trang Thời sự...");

    // Tải tin tức chính chuyên mục Thời sự
    const thoiSuNews = await fetchNewsFromRSS("thoi-su", 10);
    console.log("Tin thời sự:", thoiSuNews);
    displayCategoryNews(".thoi-su-main .category-news-list", thoiSuNews);
