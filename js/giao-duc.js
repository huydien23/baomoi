// giao-duc.js
// Xử lý hiển thị dữ liệu cho trang Giáo dục
...
async function loadCategoryNews() {
  try {
    // Tải tin tức chính chuyên mục Giáo dục
    const giaoDucNews = await fetchNewsFromRSS("giao-duc", 10);
    displayCategoryNews(".giao-duc-main .category-news-list", giaoDucNews);
