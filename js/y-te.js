// y-te.js
// Xử lý hiển thị dữ liệu cho trang Y tế
...
async function loadCategoryNews() {
  try {
    // Tải tin tức chính chuyên mục Y tế
    const yTeNews = await fetchNewsFromRSS("y-te", 10);
    displayCategoryNews(".y-te-main .category-news-list", yTeNews);
