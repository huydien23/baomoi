// the-thao.js
// Xử lý hiển thị dữ liệu cho trang Thể thao
...
async function loadCategoryNews() {
  try {
    // Tải tin tức chính chuyên mục Thể thao
    const theThaoNews = await fetchNewsFromRSS("the-thao", 10);
    displayCategoryNews(".the-thao-main .category-news-list", theThaoNews);
